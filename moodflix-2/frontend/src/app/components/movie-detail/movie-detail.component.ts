...
@Component({
        ...
        @if (trailerSafeUrl) {
          <div class="trailer-section">
            ...
            <div class="trailer-wrap">
              <iframe [src]="trailerSafeUrl" frameborder="0"
  ...
  styles: [`
    ...
    .trailer-section h2 { color: #fff; font-size: 1.5rem; font-weight: 700; margin-bottom: 1rem; }
    .trailer-wrap {
...
export class MovieDetailComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.api.getMovie(id).subscribe(m => {
      this.movie = m;
      if (m.trailer_url) {
        this.trailerSafeUrl = this.sanitizer.bypassSecurityTrustResourceUrl(m.trailer_url);
      }
    });
  }
